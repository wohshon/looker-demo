...
# The name of this view in Looker is "Web Analytics"
view: web_analytics {
  # The sql_table_name parameter indicates the underlying database table
  # to be used for all fields in this view.
  sql_table_name: `looker-demo-379302.ecommerce.web_analytics`
    ;;
...
# The name of this view in Looker is "Web Analytics Hits"
view: web_analytics__hits {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
  ...
  dimension: web_analytics__hits {
    type: string
    hidden: yes
    sql: web_analytics__hits ;;
  }
}

# The name of this view in Looker is "Web Analytics Custom Dimensions"
view: web_analytics__custom_dimensions {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
  ...
  dimension: web_analytics__custom_dimensions {
    type: string
    hidden: yes
    sql: web_analytics__custom_dimensions ;;
  }
}

# The name of this view in Looker is "Web Analytics Hits Product"
view: web_analytics__hits__product {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
...
# The name of this view in Looker is "Web Analytics Hits Promotion"
view: web_analytics__hits__promotion {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
...
# The name of this view in Looker is "Web Analytics Hits Custom Metrics"
view: web_analytics__hits__custom_metrics {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
...
# The name of this view in Looker is "Web Analytics Hits Custom Variables"
view: web_analytics__hits__custom_variables {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
...
# The name of this view in Looker is "Web Analytics Hits Custom Dimensions"
view: web_analytics__hits__custom_dimensions {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
...
# The name of this view in Looker is "Web Analytics Hits Experiment"
view: web_analytics__hits__experiment {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
...
# The name of this view in Looker is "Web Analytics Hits Publisher Infos"
view: web_analytics__hits__publisher_infos {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
...
# The name of this view in Looker is "Web Analytics Hits Product Custom Metrics"
view: web_analytics__hits__product__custom_metrics {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
...
# The name of this view in Looker is "Web Analytics Hits Product Custom Dimensions"
view: web_analytics__hits__product__custom_dimensions {
  # No primary key is defined for this view. In order to join this view in an Explore,
  # define primary_key: yes on a dimension that has no repeated values.
